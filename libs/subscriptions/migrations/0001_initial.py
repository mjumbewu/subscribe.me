...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('subscriptions_subscription', (
            ...
            ('method', self.gf('django.db.models.fields.CharField')(default='email', max_length=5)),
    ...
    models = {
        ...
        'subscriptions.subscriber': {
            'Meta': {'object_name': 'Subscriber', 'db_table': "'auth_user'", '_ormbases': ['auth.User'], 'proxy': 'True'}
        },
        'subscriptions.subscription': {
            'Meta': {'object_name': 'Subscription'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_sent': ('django.db.models.fields.DateTimeField', [], {}),
            'method': ('django.db.models.fields.CharField', [], {'default': "'email'", 'max_length': '5'}),
