...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ContentFeed.query'
        db.delete_column('subscriptions_contentfeed', 'query_id')

        # Adding field 'ContentFeed.queryset'
        db.add_column('subscriptions_contentfeed', 'queryset', self.gf('django.db.models.fields.TextField')(default='(lp0\n.'), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ContentFeed.query'
        db.add_column('subscriptions_contentfeed', 'query', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['subscriptions.StoredQuery'], unique=True), keep_default=False)
