...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('subscriptions_searchquerystore', (
            ...
            ('query', self.gf('subscriptions.models.SerializedObjectField')()),
        ))
        ...
        db.create_table('subscriptions_modelquerystore', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model', self.gf('subscriptions.models.SerializedObjectField')()),
            ('query', self.gf('subscriptions.models.SerializedObjectField')()),
        ))
    ...
    models = {
        ...
        'subscriptions.modelquerystore': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model': ('subscriptions.models.SerializedObjectField', [], {}),
            'query': ('subscriptions.models.SerializedObjectField', [], {})
        },
