...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentFeedRecord.feed_params'
        db.add_column('subscriptions_contentfeedrecord', 'feed_params',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentFeedRecord.feed_params'
        db.delete_column('subscriptions_contentfeedrecord', 'feed_params')
