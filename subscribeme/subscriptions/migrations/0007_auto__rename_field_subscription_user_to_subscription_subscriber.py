...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'Subscription.user'
        db.rename_column('subscriptions_subscription', 'user_id', 'subscriber_id')


    def backwards(self, orm):
        
        # Renaming field 'Subscription.subscriber'
        db.rename_column('subscriptions_subscription', 'subscriber_id', 'user_id')
