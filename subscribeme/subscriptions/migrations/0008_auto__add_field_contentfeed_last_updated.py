...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContentFeed.last_updated'
        db.add_column('subscriptions_contentfeed', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContentFeed.last_updated'
        db.delete_column('subscriptions_contentfeed', 'last_updated')
